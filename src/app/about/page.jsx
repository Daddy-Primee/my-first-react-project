...
export default function AboutPage() {
  return (
    <div className="bg-gray-50 text-gray-800">
      ...
      <section className="text-center py-12 md:py-16  px-6 bg-[#FAE9D7] text-[#30232d]">
      ...
      <section className="py-12 md:py-16 px-6 max-w-5xl mx-auto grid md:grid-cols-2 gap-10">
        <div>
          <h2 className="text-2xl md:text-3xl font-bold mb-3 text-[#30232d]">Our Mission</h2>
        ...
        <div>
          <h2 className="text-2xl  md:text-3xl font-bold mb-3 text-[#30232d]">Our Vision</h2>
      ...
      <section className="py-12 md:py-16 px-6 bg-white max-w-5xl mx-auto">
        <h2 className="text-2xl md:text-3xl  font-bold mb-6 text-center text-[#30232d]">
          What We Do
        </h2>
