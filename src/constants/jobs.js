...
export const Jobs = [
  ...
  requirements: [
    ...
    "Strong knowledge of programming languages such as JavaScript, TypeScript, Python, or Java.",
    "Hands-on experience with frameworks and libraries like React, Angular, or Node.js.",
...

{
  ...
  requirements: [
    ...
    "Proven work experience as a UI/UX Designer with a strong portfolio.",
...
,
  ...
  requirements: [
    ...
    "Ability to identify patterns, trends, and actionable insights.",
...
},
{
  ...
  requirements: [
    ...
    "Proven experience managing projects in a corporate environment.",
...
},
{
  ...
  requirements: [
    ...
    "Proven experience in a marketing role with successful campaigns.",
    "Knowledge of digital marketing tools and platforms (Google Ads, SEO, social media).",
    "Strong analytical skills to measure campaign effectiveness.",
    "Creative mindset with the ability to develop engaging campaigns.",
    "Excellent communication and collaboration skills.",
...

{
  ...
  requirements: [
    ...
    "Ability to conduct thorough research and simplify complex topics.",
...
},
{
  ...
  requirements: [
    ...
    "Proven experience in sales management or supervisory role.",
    "Strong leadership and team management skills.",
    "Excellent negotiation and communication abilities.",
    "Ability to analyze sales data and forecast performance.",
...
},
{
  ...
  requirements: [
    ...
    "Proven work experience in an HR role.",
...
},
{
  ...
  requirements: [
    ...
    "Proven teaching experience with leadership responsibilities.",
    "Strong classroom management and communication skills.",
    "Ability to mentor and supervise teachers effectively.",
...
},
{
  ...
  requirements: [
    ...
    "Proven teaching experience at the tertiary level.",
    "Strong research background with academic publications.",
...
},
{
...

 {
  ...
  requirements: [
    ...
    "Proven experience in operations or management role.",
...
},
{
  ...
  requirements: [
    ...
    "Experience in supply chain or logistics role.",
    "Strong analytical and problem-solving skills.",
    "Proficiency in supply chain management tools and software.",
    "Ability to monitor inventory and forecast demand.",
...
},
{
  ...
  requirements: [
    ...
    "Good computer literacy and experience with CRM tools.",
...
},
{
  ...
  requirements: [
    ...
    "Knowledge of SEO, SEM, Google Analytics, and social media marketing.",
...
},
{
  ...
  requirements: [
    ...
    "Proven experience as a graphic designer with portfolio.",
    "Proficiency in Adobe Creative Suite (Photoshop, Illustrator, InDesign).",
    "Creativity and ability to translate concepts into visuals.",
...
},
{
  ...
  requirements: [
    ...
    "Proven experience as a journalist or reporter.",
...
},
{
  ...
  requirements: [
    ...
    "Proven experience in corporate law or related field.",
    "Strong drafting and negotiation skills.",
    "Good knowledge of local labor and commercial laws.",
...
},
{
  ...
  requirements: [
    ...
    "Proven experience in civil engineering projects.",
    "Strong knowledge of engineering design and construction standards.",
...
},
{
  ...
  requirements: [
    ...
    "Proven work experience as a mechanical engineer.",
    "Strong knowledge of mechanical systems and design software.",
    "Ability to troubleshoot and repair machinery.",
...
},
{
  ...
  requirements: [
    ...
    "Proven experience working on electrical projects.",
...
},
{
  ...
  requirements: [
    ...
    "Experience in warehouse supervision or related role.",
    "Strong organizational and inventory management skills.",
    "Ability to supervise and train warehouse staff.",
...
},
{
  ...
  requirements: [
    ...
    "Proven driving experience, preferably in logistics or delivery.",
    "Knowledge of traffic regulations and safety practices.",
    "Good communication and customer service skills.",
    "Ability to plan routes and manage time effectively.",
...
},
{
  ...
  requirements: [
    ...
    "Knowledge of security protocols and safety procedures.",
...
},
{
  ...
  requirements: [
    "Proven experience as a chef or cook in a restaurant or hotel.",
...
},
{
  ...
  requirements: [
    "Bachelor’s degree in Business, Marketing, or related field.",
    "Proven experience in sales or related role.",
...
},
{
  ...
  requirements: [
    ...
    "Good knowledge of sales strategies and retail operations.",
...
},
{
  ...
  requirements: [
    "Master’s degree or PhD in Biology, Chemistry, or related field.",
    "Proven research experience with publications.",
...
},
{
  ...
  requirements: [
    "Certification in personal training or fitness instruction.",
    "Experience as a fitness trainer or coach.",
    "Strong knowledge of exercise techniques and nutrition.",
    "Good motivational and communication skills.",
    "Ability to personalize training programs.",
...
},
{
  ...
  requirements: [
    ...
    "Proven experience in a pharmacy or hospital setting.",
    "Strong knowledge of medications and interactions.",
...
},
{
  ...
  requirements: [
    ...
    "Valid license to practice as a Nurse in Nigeria.",
    "Experience in clinical or hospital settings.",
    "Compassionate and patient-centered approach.",
    "Ability to administer medications and treatments safely.",
    "Good communication and teamwork skills.",
...
},
{
  ...
  requirements: [
    ...
    "Valid license to practice medicine in Nigeria.",
    "Proven experience as a doctor in a hospital or clinic.",
...
},
{
  ...
  requirements: [
    ...
    "Valid license to practice as a Dentist.",
    "Proven experience in dental practice.",
    "Strong knowledge of dental procedures and hygiene.",
...
},
{
  ...
  requirements: [
    ...
    "Teaching certification or license is preferred.",
    "Proven experience as a teacher.",
    "Strong communication and classroom management skills.",
    "Ability to prepare engaging lesson plans.",
...
},
{
  ...
  requirements: [
    "Master’s degree or PhD in relevant subject area.",
    "Proven teaching experience in a university setting.",
...
},
{
  ...
  requirements: [
    ...
    "Proven experience as an animator with portfolio.",
    "Proficiency in animation software such as After Effects or Blender.",
    "Creativity and ability to bring ideas to life.",
    "Good communication and teamwork skills.",
...
},
{
  ...
  requirements: [
    "Proven experience as a videographer with portfolio.",
    "Proficiency in video editing software such as Premiere Pro or Final Cut Pro.",
    "Knowledge of lighting, sound, and camera equipment.",
    "Creativity and ability to tell stories visually.",
    "Good communication and teamwork skills.",
...
},
{
  ...
  requirements: [
    ...
    "Proficiency in photo editing software like Photoshop or Lightroom.",
    "Knowledge of photography equipment and lighting techniques.",
...
},
{
  ...
  requirements: [
    ...
    "Ability to manage recruitment and training programs.",
...
},
{
  ...
  requirements: [
    ...
    "Knowledge of computer hardware, networks, and software troubleshooting.",
    "Strong communication and customer service skills.",
    "Ability to document and resolve technical issues efficiently.",
    "Good organizational and multitasking skills.",
...
},
{
  ...
  requirements: [
    ...
    "Knowledge of backend technologies like Node.js or PHP.",
